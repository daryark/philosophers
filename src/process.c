...
/*   Updated: 2024/07/06 16:33:22 by dyarkovs         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void leave_forks(t_philo *philo)
{
    ...
    safe_mtx(&philo->data->forks[philo->fork2_id - 1].fork,philo->fork2_id, philo, 'u');
    safe_mtx(&philo->data->forks[philo->fork1_id -1].fork, philo->fork1_id, philo, 'u');
    //  pthread_mutex_lock(&philo->data->print_lock); //!
